...
::	pushapp N:\18831\SM8150\android\out\target\product\guacamolet FactoryTest [32]
set image_dir=%1
set module_name=%2
set arch_tmp=%3
set null=
...
set src_dir=%image_dir%\system\app\%module_name%
...
set dst_dir=/system/app/%module_name%
